...
anosim(datab, data_$MBSD, distance = "bray", permutations = 1000) # p = 0.0009

# PERMANOVA
permanova = adonis2(datab ~ data_$MBSD)
print(permanova) # p = 0.001
#remotes::install_github("phytomosaic/ecole")
library(ecole)
pairwise_result = permanova_pairwise(datab, data_$MBSD, permutations = 999, method = "bray", padj = "bonferroni")
