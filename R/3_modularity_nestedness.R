...
############## ANALYSIS 1.0 DATASET 1: AGGREGATED ##############
...
png(filename= "figures/figS6A_modularityFree_aggregated_Dataset1.png", res= 300, height= 3000, width= 3000)
...
png(filename= "figures/figS6BCD_nestednessRestric_aggregated_Dataset1.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
...
#Plot the matrix
png(filename= "figures/fig4_Dataset1_labelGrande.png", res= 300, height= 2000, width= 3700)
plotmatrix(data.comp$matrix, 
           ...
           plot_labels = T,
           cex.axis = 0.3, srt=90,
           las = 2) # angle of values in x and y axes
dev.off()

# Correct the colors in Photoshop based on layers. See View(data.comp$matrix)

############## ANALYSIS 1.1 DATASET 1: NEOTROPICAL ##############
############## 1. PREPARING THE DATA ##############
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS6E_modularityFree_neotropical_Dataset1.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)    
dev.off()
...
#Plot the observed nestedness value against the distribution of randomized values
png(filename= "figures/figS6FGH_nestednessRestric_neotropical_Dataset1.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
#Plot the observed nestedness value against the distribution of randomized values
'''
png(filename= "figures/figS6_nestednessFree_all_neotropical.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
############## ANALYSIS 1.2 DATASET 1: INDO-MALAYAN-AUSTRALASIA ##############
############## 1. PREPARING THE DATA ##############
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS6I_modularityFree_asia_Dataset1.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)    
dev.off()
...
#Plot the observed nestedness value against the distribution of randomized values
png(filename= "figures/figS6JKL_nestednessRestric_asia_Dataset1.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
############## ANALYSIS 2.0 DATASET 2: AGGREGATED ##############
############## 1. PREPARING THE DATA ##############
...
data = data[c(0:61), ] # keep rows with bees
data = data[, 62:ncol(data)] # keep only columns of plants
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS7A_modularity_aggregated_Dataset2.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)
dev.off()
...
#Plot the observed nestedness value against the distribution of randomized values
png(filename= "figures/figS7BCD_nestednessRestric_aggregated_Dataset2.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
#Plot the observed nestedness value against the distribution of randomized values
'''
png(filename= "figures/figS7_nestednessFree_CF_aggregated.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
#Plot the matrix
png(filename= "figures/fig4B_Dataset2_outro.png", res= 300, height= 2000, width= 3700)
plotmatrix(data.comp$matrix, 
           row_partitions = data.comp$row_partitions, 
           col_partitions = data.comp$col_partitions, 
           border = T,
...
############## ANALYSIS 2.1 DATASET 2: NEOTROPICAL ##############
############## 1. PREPARING THE DATA ##############
...
# Create an adjacent matrix for bipartite
data = get.adjacency(data,sparse=FALSE)
data = data[c(0:29), ] # keep rows with bees
data = data[, 30:ncol(data)] # keep only columns of plants
data <- empty(data, count = F) # remove nodes with no interactions
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS7E_modularityFree_neotropical_Dataset2.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)
dev.off()
...
#Plot the observed nestedness value against the distribution of randomized values
png(filename= "figures/figS7FGH_nestedness_neotropical_Dataset2.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS7I_modularityFree_asia_Dataset2.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)
dev.off()
...
#Plot the observed nestedness value against the distribution of randomized values
png(filename= "figures/figS7JKL_nestedness_asia_Dataset2.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
############## ANALYSIS 3.0 DATASET 3: AGGREGATED ##############
############## 1. PREPARING THE DATA ##############
...
# Create an adjacent matrix for bipartite
data = get.adjacency(data,sparse=FALSE)
data = data[c(0:60), ] # keep rows with bees
data = data[, 61:ncol(data)] # keep only columns of plants
data <- empty(data, count = F) # remove nodes with no interactions
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS8A_modularityFree_aggregated_Dataset3.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)
dev.off()
...
#Plot the observed nestedness value against the distribution of randomized values
png(filename= "figures/figS8BCD_nestednessRestric_aggregated_Dataset3.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
#Plot the matrix
png(filename= "figures/fig4C_Dataset3_outro.png", res= 300, height= 2000, width= 3700)
plotmatrix(data.comp$matrix, 
           row_partitions = data.comp$row_partitions, 
           col_partitions = data.comp$col_partitions, 
           border = T,
...
############## ANALYSIS 3.1 DATASET 3: NEOTROPICAL ##############
############## 1. PREPARING THE DATA ##############
...
# Create an adjacent matrix for bipartite
data = get.adjacency(data,sparse=FALSE)
data = data[c(0:28), ] # keep rows with bees
data = data[, 29:ncol(data)] # keep only columns of plants
data <- empty(data, count = F) # remove nodes with no interactions
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS8E_modularityFree_neotropical_Dataset3.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)
dev.off()
...
#Plot the observed nestedness value against the distribution of randomized values
png(filename= "figures/figS8FGH_nestedness_neotropical_Dataset3.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
############## ANALYSIS 3.2 DATASET 3: INDO-MALAYA ##############
############## 1. PREPARING THE DATA ##############
...
# Load edge and node lists
nodes = read.delim("data/net1nodes_IndoMalayan_Dataset3.txt", header = T) # node traits
links = read.delim("data/list.IndoMalaya.Dataset3.txt", header = T) # list of interactions
# Load network
data <- graph_from_data_frame(d=links, vertices=nodes, directed=F)
# Create an adjacent matrix for bipartite
data = get.adjacency(data,sparse=FALSE)
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS8I_modularityFree_indomalaya_Dataset3.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)
dev.off()
...
#Plot the observed nestedness value against the distribution of randomized values
png(filename= "figures/figS8JKL_nestedness_indomalayan_Dataset3.png", res= 300, height= 1800, width= 6000)
par(mfrow = c(1,3))
plot(density(NODF.null), xlim=c(min(obs[3], min(NODF.null)), max(obs[3], max(NODF.null))), 
     main="Observed vs. randomized", xlab = "NODF matrix")
abline(v=obs[3], col="red", lwd=2)    
...
############## ANALYSIS 3.3 DATASET 3: AUSTRALIAN ##############
############## 1. PREPARING THE DATA ##############
...
# Load edge and node lists
nodes = read.delim("data/net1nodes_Australian_Dataset3.txt", header = T) # node traits
links = read.delim("data/list.Australia.Dataset3.txt", header = T) # list of interactions
# Load network
data <- graph_from_data_frame(d=links, vertices=nodes, directed=F)
# Create an adjacent matrix for bipartite
data = get.adjacency(data,sparse=FALSE)
data = data[c(0:3), ] # keep rows with bees
data = data[, 4:ncol(data)] # keep only columns of plants
data <- empty(data, count = F) # remove nodes with no interactions
...
#Plot the observed modularity value against the distribution of randomized values
png(filename= "figures/figS8M_modularityFree_australia_Dataset3.png", res= 300, height= 3000, width= 3000)
plot(density(like.nulls), xlim=c(min((Mod@likelihood), min(like.nulls)), max((Mod@likelihood), max(like.nulls))), 
     main="Observed vs. randomized")
abline(v=(Mod@likelihood), col="red", lwd=2)
dev.off()
...
############## ANALYSIS 4.0 CHEMICAL: AGGREGATED ##############
############## 1. PREPARING THE DATA ##############
...
plotmatrix(data.comp$matrix, 
           ...
           between_color = "lightgrey")
dev.off()
############## ANALYSIS 5.0 FIELDWORK: AGGREGATED ##############
############## 1. PREPARING THE DATA ##############
...
plotmatrix(data.comp$matrix, 
           ...
           between_color = "lightgrey")
dev.off()
############## ANALYSIS 6.0 PALYNOLOGICAL: AGGREGATED ##############
############## 1. PREPARING THE DATA ##############
