...
#### DATASET 1: PHYLOGENY VS INTERACTIONS (CONTROL: NONE) ####
...
#### DATASET 1: PHYLOGENY VS MODULES (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
data_mod = read_tsv("data/partitions_Dataset1.txt")
...
#### DATASET 1: PHYLOGENY VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
data_layer = read_tsv("data/layers_Dataset1.txt")
...
#### DATASET 1: MODULES VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
#### DATASET 1: INTERACTIONS VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
#### DATASET 2: PHYLOGENY VS INTERACTIONS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
#### DATASET 2: PHYLOGENY VS MODULES (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
# MODULE DISTANCE MATRIX
# Read module dataframe
data_mod = read_tsv("data/partitions_Dataset2.txt")
...
#### DATASET 2: PHYLOGENY VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
# LAYER DISTANCE MATRIX
data_layer = read_tsv("data/layers_Dataset2.txt")
data_layer = dcast(data_layer, Species ~ Layer, fun.aggregate = length) # create a binary adjacency matrix of modules
rownames(data_layer) <- data_layer$Species # turn the first column into rownames
data_layer <- data_layer[, -1] # remove first column
dist_layer = vegdist (data_layer, diag=TRUE, upper=T, method="jaccard", binary=T)
...
#### DATASET 2: MODULES VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
# Read module dataframe
data_mod = read_tsv("data/partitions_Dataset2.txt")
data_mod = data_mod[c(0:61), ] # keep only rows of bees
data_mod = data_mod[, 1:2] # keep only columns of plants
data_mod = dcast(data_mod, nodes ~ module, fun.aggregate = length) # create a binary adjacency matrix of modules
rownames(data_mod) <- data_mod$nodes
data_mod <- data_mod[, -1]
...
#### DATASET 2: INTERACTIONS VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
#### DATASET 3: PHYLOGENY VS INTERACTIONS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
#### DATASET 3: PHYLOGENY VS MODULES (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
# MODULE DISTANCE MATRIX
# Read module dataframe
data_mod = read_tsv("data/partitions_Dataset3.txt")
data_mod = data_mod[c(0:60), ] # keep only rows of bees
data_mod = data_mod[, 1:2] # keep only columns of plants
data_mod = dcast(data_mod, nodes ~ module, fun.aggregate = length) # create a binary adjacency matrix of modules
rownames(data_mod) <- data_mod$nodes
data_mod <- data_mod[, -1]
...
#### DATASET 3: PHYLOGENY VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
# LAYER DISTANCE MATRIX
data_layer = read_tsv("data/layers_Dataset3.txt")
data_layer = dcast(data_layer, Species ~ Layer, fun.aggregate = length) # create a binary adjacency matrix of modules
rownames(data_layer) <- data_layer$Species # turn the first column into rownames
data_layer <- data_layer[, -1] # remove first column
dist_layer = vegdist (data_layer, diag=TRUE, upper=T, method="jaccard", binary=T)
...
#### DATASET 3: MODULES VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
...
#### DATASET 3: INTERACTIONS VS LAYERS (CONTROL: NONE) ####
#Delete all previous objects
rm(list= ls())
#Clear the console
cat("\014") 
